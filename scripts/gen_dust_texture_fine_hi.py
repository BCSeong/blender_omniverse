"""Generate fine-only dust textures at high coverage: 20x/30x/40x/50x.

Medium=300, Large=30 (fixed at base).

Usage: python gen_dust_texture_fine_hi.py
"""
import os
import numpy as np
...
if __name__ == "__main__":
    ...
    configs = [
        ("sphere_M1_dust_fine_20x.png",  60000, 60),
        ("sphere_M1_dust_fine_30x.png",  90000, 61),
        ("sphere_M1_dust_fine_40x.png", 120000, 62),
        ("sphere_M1_dust_fine_50x.png", 150000, 63),
    ]
